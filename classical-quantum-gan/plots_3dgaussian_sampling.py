...
def generate_fake_samples(circuit, params, latent_dim, samples, nqubits, layers, nshots):
    ...
    for i in range(samples):
        ...
        circuit_execute = circuit(nshots=nshots).frequencies(binary=True)
...
def main(samples, bins, latent_dim, layers, training_samples, batch_samples, lr, plot_real, nshots):
    ...
    x_fake, _ = generate_fake_samples(circuit, params, latent_dim, samples, nqubits, layers, nshots)
    x_fake1 = []
    x_fake2 = []
    x_fake3 = []
    for i in range(samples):
    ...
    plt.hist(np.array(x_fake1), np.linspace(-1.0, 1.0, bins), color='blue', histtype='step', label='fake', alpha=0.5)
    plt.rcParams["axes.linewidth"]  = 1.25
    plt.legend()
    plt.text(-1.0, max(fake.flatten())*samples, 'KL divergence = '+str(kl_divergence), bbox=dict(fill=False, edgecolor='black', linewidth=2))
    plt.show()
    fig.savefig(f"1-distribution_{samples}_{bins}_{nqubits}_{latent_dim}_{layers}_{training_samples}_{batch_samples}_{lr}_{nshots}.pdf", bbox_inches='tight')
    ...
    plt.text(-1.0, max(fake.flatten())*samples, 'KL divergence = '+str(kl_divergence), bbox=dict(fill=False, edgecolor='black', linewidth=2))
    plt.show()
    fig.savefig(f"2-distribution_{samples}_{bins}_{nqubits}_{latent_dim}_{layers}_{training_samples}_{batch_samples}_{lr}_{nshots}.pdf", bbox_inches='tight')
    ...
    plt.text(-1.0, max(fake.flatten())*samples, 'KL divergence = '+str(kl_divergence), bbox=dict(fill=False, edgecolor='black', linewidth=2))
    plt.show()
    fig.savefig(f"3-distribution_{samples}_{bins}_{nqubits}_{latent_dim}_{layers}_{training_samples}_{batch_samples}_{lr}_{nshots}.pdf", bbox_inches='tight')
    ...
    plt.rcParams["axes.linewidth"]  = 1.25
    plt.show()
    fig.savefig(f"1-2_FAKE_{samples}_{bins}_{nqubits}_{latent_dim}_{layers}_{training_samples}_{batch_samples}_{lr}_{nshots}.pdf", bbox_inches='tight')
    ...
    plt.rcParams["axes.linewidth"]  = 1.25
    plt.show()
    fig.savefig(f"2-3_FAKE_{samples}_{bins}_{nqubits}_{latent_dim}_{layers}_{training_samples}_{batch_samples}_{lr}_{nshots}.pdf", bbox_inches='tight')
    ...
    plt.rcParams["axes.linewidth"]  = 1.25
    plt.show()
    fig.savefig(f"3-1_FAKE_{samples}_{bins}_{nqubits}_{latent_dim}_{layers}_{training_samples}_{batch_samples}_{lr}_{nshots}.pdf", bbox_inches='tight')
