...
replot 'measure.3dhist_5' u 2:4:5 w yerrorlines ps 3 pt 7 lc rgb "blue" ti '5'
replot 'measure.3dhist_7' u 2:4:5 w yerrorlines ps 3 pt 9 lc rgb "magenta" ti '7'
replot 'measure.3dhist_10' u 2:4:5 w yerrorlines ps 3 pt 11 lc rgb "orange" ti '10'

replot './../correlations/measure.3dhist_1' u  2:4:5 w yerrorlines ps 3 pt 5 lc rgb "black" ti 'temp, n_{layers}=1'
...
replot 'measure.veig2_3D_5' u 2:(\$4+\$5+\$6) w lp ps 3 pt 7 lc rgb "blue" ti '5'
replot 'measure.veig2_3D_7' u 2:(\$4+\$5+\$6) w lp ps 3 pt 9 lc rgb "magenta" ti '7'
replot 'measure.veig2_3D_10' u 2:(\$4+\$5+\$6) w lp ps 3 pt 11 lc rgb "orange" ti '10'

replot './../correlations/measure.veig2_3D_1' u 2:(\$4+\$5+\$6) w lp ps 3 pt 5 lc rgb "black" ti 'temp, n_{layers}=1'
...
replot 'measure.correig_5' u 2:4 w lp ps 3 pt 7 lc rgb "blue" ti '5'
replot 'measure.correig_7' u 2:4 w lp ps 3 pt 9 lc rgb "magenta" ti '7'
replot 'measure.correig_10' u 2:4 w lp ps 3 pt 11 lc rgb "orange" ti '10'

rep f(x) w l lt -1 lw 3 dt 4 lc 'grey' ti 'f(x)=1+b exp(-mx)'

replot './../correlations/measure.correig_1' u 2:4 w lp ps 3 pt 5 lc rgb "black" ti 'temp, n_{layers}=1'
...
replot 'measure.correig_5' u 2:5 w lp ps 3 pt 7 lc rgb "blue" ti '5'
replot 'measure.correig_7' u 2:5 w lp ps 3 pt 9 lc rgb "magenta" ti '7'
replot 'measure.correig_10' u 2:5 w lp ps 3 pt 11 lc rgb "orange" ti '10'

#rep f(x) w l lt -1 lw 3 lc 'black' ti 'f(x)=1+b exp(-mx)'

replot './../correlations/measure.correig_1' u 2:5 w lp ps 3 pt 5 lc rgb "black" ti 'temp, n_{layers}=1'
...
replot 'measure.corr_5' u 2:7 w lp ps 3 pt 7 lc rgb "blue" ti '5'
replot 'measure.corr_7' u 2:7 w lp ps 3 pt 9 lc rgb "magenta" ti '7'
replot 'measure.corr_10' u 2:7 w lp ps 3 pt 11 lc rgb "orange" ti '10'

replot './../correlations/measure.corr_1' u 2:7 w lp ps 3 pt 5 lc rgb "black" ti 'temp, n_{layers}=1'
