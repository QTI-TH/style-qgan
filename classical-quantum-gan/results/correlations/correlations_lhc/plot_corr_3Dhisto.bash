...
splot 'results/qc_3_5_2.2dsubhist1' using 1:2:3 w l lw 0 lc 'black' noti 
...
set out '3dgauss_density1_EM_target.png
rep
set out
set term xterm
...
splot 'results/qc_3_5_2.2dsubhist2' using 1:2:3 w l lw 0 lc 'black' noti 
...
set term pngcairo size 1600, 1200 truecolor enhanced font "Helvetica,34"
set out '3dgauss_density1_ER_target.png
rep
set out
set term xterm
...
splot 'results/qc_3_5_2.2dsubhist3' using 1:2:3 w l lw 0 lc 'black' noti 
...
set term pngcairo size 1600, 1200 truecolor enhanced font "Helvetica,34"
set out '3dgauss_density1_MR_target.png
rep
set out
set term xterm
...
splot 'results/qc_3_${lat}_${lay}.2dsubhist1' using 1:2:(\$3-\$4) w l lw 1 lc 'black' noti 
...
set term pngcairo size 1600, 1200 truecolor enhanced font "Helvetica,34"
set out '3dgauss_density1_EM_${lat}_${lay}.png
rep
set out
set term xterm
...
splot 'results/qc_3_${lat}_${lay}.2dsubhist2' using 1:2:(\$3-\$4) w l lw 1 lc 'black' noti 
...
set term pngcairo size 1600, 1200 truecolor enhanced font "Helvetica,34"
set out '3dgauss_density1_ER_${lat}_${lay}.png
rep
set out
set term xterm
...
splot 'results/qc_3_${lat}_${lay}.2dsubhist3' using 1:2:(\$3-\$4) w l lw 1 lc 'black' noti 
...
set term pngcairo size 1600, 1200 truecolor enhanced font "Helvetica,34"
set out '3dgauss_density1_MR_${lat}_${lay}.png
rep
set out
set term xterm
