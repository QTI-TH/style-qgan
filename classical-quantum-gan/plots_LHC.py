...
def generate_fake_samples(circuit, params, latent_dim, samples, nqubits, layers):
...
def main(samples, bins, latent_dim, layers, training_samples, batch_samples, lr):
    ...
    x_fake, _ = generate_fake_samples(circuit, params, latent_dim, samples, nqubits, layers)
