...
def generate_real_samples(samples, distribution):
...
def train(d_model, latent_dim, n_epochs=30000, samples=128):
    d_loss = []
    g_loss = []
    ...
    s = load_events('data/ppttbar_10k_events.lhe')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--real_samples", default=10000, type=float)
