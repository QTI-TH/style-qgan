...
the Harrow-Hassidim-Lloyd (HHL) algorithm~\cite{harrow2009quantum}. This approach holds
promise for the future, though its utility depends on the existance of large-scale quantum computers with low gate
errors and enough qubits to perform quantum error correction.{\color{red} D.: Which approach? The one using HHL or in general QML. It is not clear in this context.} On the other hand, more
...
classification~\cite{havlivcek2019supervised, Schuld:2020circuit,
  ...
  bravo2021quantum, cao2021noise}. This QML approach to quantum
...
possibility of using QNNs for generative modeling~\cite{benedetti2019generative,
  hamilton2019generative, coyle2020born}. More specifically, we explore the uses of QNNs for the generation of
