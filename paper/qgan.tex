...
qGAN model is publicly available through the {\tt Qibo}
...
physical observable to experimental data. In this context, ideally, we could try
...
We consider a 3-qubit model with 5 latent dimensions and 4 layers. The $U_{\rm
ent}$ consists of two controlled-$R_{y}$ gates acting sequentially on the 3
qubits. The total number of variational parameters is {\color{red} XX}. The
style-qGAN model has been trained on $10^4$ samples.
