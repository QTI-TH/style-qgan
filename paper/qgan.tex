...
\begin{figure*}
  ...
  \caption{\label{fig:3dgauss}Marginal samples distributions for each dimension $x,y,z$
    ...
    a grey background for the plots in the bottom row to highlight when the reference and generated samples are identical.}
\end{figure*}
...
\begin{figure*}
  ...
  \caption{\label{fig:ttbar}
    ...
    provides acceptable samples when compared to the reference distribution. Note that we choose a grey
    background for the plots in the bottom row to highlight when the reference and generated samples are identical.
}
\end{figure*}
