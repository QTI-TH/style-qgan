...
\commentAF{(Revisit) It would be good to expand a little more on the implementation here. This is not really featured so far. Start:\\
...
\commentAF{want to change "In order to compare quantum technologies we have also performed a run with $10^3$ samples only on IonQ machines, compared to a run on IBM~Q
