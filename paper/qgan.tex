...
\begin{abstract}
  We propose and assess an alternative quantum generator architecture in the context of generative adversarial learning for the generation of
  Monte Carlo events. We validate
  the methodology by implementing our quantum network on artificial data generated from
