...
\begin{figure*}
  ...
  \includegraphics[width=0.3\textwidth]{plots/LHCttbar/s-t_RATIO_10k.pdf}%
  \includegraphics[width=0.3\textwidth]{plots/LHCttbar/t-y_RATIO_10k.pdf}%
  \includegraphics[width=0.3\textwidth]{plots/LHCttbar/y-s_RATIO_10k.pdf}
...
\begin{figure*}
  ...
  \includegraphics[width=0.3\textwidth]{plots/LHCttbar/s-t_RATIO_100k.pdf}%
  \includegraphics[width=0.3\textwidth]{plots/LHCttbar/t-y_RATIO_100k.pdf}%
  \includegraphics[width=0.3\textwidth]{plots/LHCttbar/y-s_RATIO_100k.pdf}
...
\begin{figure*}
  ...
  \includegraphics[width=0.3\textwidth]{plots/hardware_1k/ibm_lagos/s-t_RATIO_IBM_10k.pdf}%
  \includegraphics[width=0.3\textwidth]{plots/hardware_1k/ibm_lagos/t-y_RATIO_IBM_10k.pdf}%
  \includegraphics[width=0.3\textwidth]{plots/hardware_1k/ibm_lagos/y-s_RATIO_IBM_10k.pdf}
