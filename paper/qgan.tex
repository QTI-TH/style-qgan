...
\begin{figure*}
  ...
  Marginal samples distribution (bottom row) for each dimension compared to the the reference underlying prior MC
   distribution. \commentCBP{In the middle row, do we want to plot noise simulation/generated or reference/noise simulation ? Anyhow, please Julien could you change the title to show the full word "simulation" instead of "simu"?}}
\end{figure*}
