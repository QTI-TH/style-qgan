...
\begin{figure*}
  ...
  \caption{\label{fig:circuit}Ansatz for the quantum generator.}
\end{figure*}
...
\begin{figure*}
  \includegraphics[width=0.49\textwidth]{plots/1Dgamma/1Dgamma_distribution_10k.pdf}
  \includegraphics[width=0.49\textwidth]{plots/1Dgamma/1Dgamma_distribution_100k.pdf}
  \caption{Example of 1D gamma distribution.}
\end{figure*}

\begin{figure}
  \includegraphics[width=0.5\textwidth]{plots/1Dgamma/1Dgamma_loss.pdf}
  \caption{Example of loss function evolution.}
\end{figure}
