...
import numpy as np
from qgenerator_piece import single_qubit_generator
from qclassifier_piece import single_qubit_classifier
...
if new_qdiscriminator==1:
    ...
    dresult, dparameters = qd.minimize(method='cma', options={'seed':113895, 'maxiter': 2})
...
if new_qgenerator==1:
    ...
    # genetic algorithm seems to work better
    gresult, gparameters = qg.minimize(method='cma', options={'seed':113895, 'maxiter': 2})
